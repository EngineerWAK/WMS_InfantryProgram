...
/*
MODS LIST:
RHSAFRF, RHSUSAF, RHSGREF, 3CB (+RKSL), R3F, BWMod, NIarms all in one, VSM National Gear Pack
*/
/////////////////////////////////
...
WMS_Loadout_Assault = [//545 556 57 58
	 ...
	 [], //_mainWeapsAmmo
	 ["optic_mrco","rhsusf_acc_ACOG_USAC","rhs_acc_okp7_picatinny","rhsusf_acc_compm4","rhsusf_acc_su230","RKSL_optic_LDS","UK3CB_BAF_SUIT"], //_scopes
...
WMS_Loadout_DMR = [
	 ...
	 [], //_mainWeapsAmmo,
	 ["rhsusf_acc_ACOG_USAC","rhsusf_acc_su230","RKSL_optic_LDS","R3F_SB_PM_BLACK","optic_DMS","BWA3_optic_PMII_ShortdotCC","BWA3_optic_PMII_DMR"], //_scopes
	 ["hlc_pistol_P229R_Combat","hlc_pistol_P229R_40Combat","hlc_pistol_P229R_357Combat"] //_pistols
];
...
WMS_Weaps_HeavyBandit = [
	...
	"rhsusf_acc_LEUPOLDMK4",
	 ...
	 ["hgun_Pistol_heavy_01_green_F","hgun_Pistol_heavy_01_F","Exile_Weapon_Taurus","hgun_Pistol_heavy_01_green_F","hgun_Pistol_heavy_01_F","Exile_Weapon_Taurus"] //_pistols
];
WMS_Loadout_Livonia = [
