...
private ["_posLeader","_paradropAIrunning","_patrolAIrunningOP","_patrolAIrunningBL","_DynAIrunning","_grpArray","_vhl","_obj","_mkr","_wps","_ref", "_cnt"];
...
//keep for later
//_targetList = allPlayers select {alive _x && (_x distance2D _triggRef < WMS_triggCheckDist)} apply {_x};
//
//paradrop
