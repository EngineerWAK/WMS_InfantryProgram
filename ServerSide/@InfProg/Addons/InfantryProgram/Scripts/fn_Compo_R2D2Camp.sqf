...
]; //this could be changed by a server variable like 'private _objects = WMS_object_compo_R2D2Camp', same for the units (MG) datas.
...
if (_armed == 1) then { 
	...
	"B_G_Soldier_AR_F" createUnit [_compoRefPoint modeltoworld [6.32544,2.29013,0], _campGrp1,"[this,'BunkerMG',0,(0.5 + random 0.4),_loadout] call WMS_fnc_DynAI_SetUnitBLU;"];  
	_campGrp1 setFormDir (63.2 + _dirPlayer);
	"B_G_Soldier_AR_F" createUnit [_compoRefPoint modeltoworld [-6.39924,-2.65703,0], _campGrp2,"[this,'BunkerMG',0,(0.5 + random 0.4),_loadout] call WMS_fnc_DynAI_SetUnitBLU;"];  
