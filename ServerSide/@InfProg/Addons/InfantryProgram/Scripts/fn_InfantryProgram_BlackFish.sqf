...
private ["_timer","_lockerMoney","_playerMoney","_poptabsplayer","_ownerUID","_playerUID_ExileMoney","_RandomPosSpawn","_vhl","_RandomPosEnd","_vehic","_grp","_markerPos","_markerName","_markerName2","_BlackFishSupport","_BlackFishSupport2","_WPT_AirSupport1","_WPT_AirSupport2"];
params [
  "_target",
  "_pos",
  "_amount",
...
if(_lockerMoney > _amount) then {
  ...
  _RandomPosSpawn = [_target, 1200, 2200] call BIS_fnc_findSafePos;
  _vhl = [_RandomPosSpawn, (0+random 359), _plane, BLUFOR] call bis_fnc_spawnvehicle;
  _RandomPosEnd = [_pos, worldSize, (worldSize*1.2)] call BIS_fnc_findSafePos;      
  ...
  _markerPos = _pos; 
  _markerName = "Grid" + (str _markerPos);  
  _markerName2 = "BlackFish" + (str _markerPos);
  _BlackFishSupport = createMarker [_markerName, _markerPos]; 
  ...
  _BlackFishSupport2 = createMarker [_markerName2, _markerPos]; 
  ...
  _WPT_AirSupport1 = _grp addWaypoint [position _target, 150];
  ...
  _WPT_AirSupport2 = _grp addWaypoint [_pos, 500];
