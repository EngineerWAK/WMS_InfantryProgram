...
/*
MODS LIST:
ACE3, RHSAFRF, RHSUSAF, RHSGREF, 3CB (+RKSL), R3F, BWMod, NIarms all in one, VSM National Gear Pack
*/
...
WMS_Loadout_AssaultPlus = [//65 68 762
	 [
	 ...
	 [], //_mainWeapsAmmo
	 ["optic_mrco","rhsusf_acc_ACOG_USMC","rhs_acc_okp7_picatinny","rhsusf_acc_compm4","rhsusf_acc_su230","RKSL_optic_LDS","UK3CB_BAF_SUIT"], //_scopes
	 ["hlc_pistol_P239_357","hlc_pistol_P229R_40Combat","hlc_pistol_P229R_357Combat"] //_pistols
];
WMS_Loadout_DMR = [
	 [
		"UK3CB_BAF_L129A1",
		"hlc_rifle_FAL5000Rail","hlc_rifle_g3sg1ris","hlc_rifle_M14_Bipod_Rail","hlc_rifle_M21_Rail",
		"srifle_DMR_03_F","R3F_SCAR_H_PR_20pcs_TAN","rhs_weap_svdp_npz","rhs_weap_sr25_ec","BWA3_G28",
...
WMS_Loadout_MG = [ //arifle_RPK12_F, LMG_Mk200_black_F
	 [
		"hlc_lmg_minimipara","hlc_rifle_RPK12","rhs_weap_m249","hlc_lmg_m60","rhs_weap_mg42","LMG_03_F","hlc_rifle_MG36",
		"rhs_weap_pkp",
		"R3F_FN_MAG58",//R3F
		"BWA3_MG4",//BWmod
...
WMS_Loadout_Sniper = [
	 [
		...
		"BWA3_G29","srifle_LRR_F","UK3CB_BAF_L115A3_DE"], //_mainWeaps,
	 [], //_mainWeapsAmmo,
...
WMS_Loadout_SMG = [
	 [
		"hlc_smg_mp510","hlc_smg_mp5a3","hlc_smg_mp5sd6","hlc_smg_9mmar","hlc_smg_mp5k_PDW","hlc_rifle_auga2para_b",
		"rhs_weap_pp2000"], //_mainWeaps,
	 [], //_mainWeapsAmmo,
...
WMS_Weaps_LivoniaMix = [
	...
	"rhs_weap_XM2010_sa",
	 ...
	 ["hgun_Pistol_heavy_01_green_F","hgun_Pistol_heavy_01_F","hgun_Pistol_heavy_01_green_F","hgun_Pistol_heavy_01_F","hlc_pistol_DL44"] //_pistols
];
WMS_Loadout_diver = [
