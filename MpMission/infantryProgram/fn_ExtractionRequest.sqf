...
[]spawn {
	...
	onMapSingleClick {
		...
		private _choppa = selectrandom ["UK3CB_BAF_Wildcat_AH1_TRN_8A","UK3CB_BAF_Merlin_HC3_32"];
		[player,_pos,_choppa,0,_vehicVarName] remoteExec ["WMS_fnc_infantryProgram_extraction"];
